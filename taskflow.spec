...
Version  : 2.6.0
Release  : 38
URL      : http://tarballs.openstack.org/taskflow/taskflow-2.6.0.tar.gz
Source0  : http://tarballs.openstack.org/taskflow/taskflow-2.6.0.tar.gz
