...
Version  : 2.4.0
Release  : 37
URL      : http://tarballs.openstack.org/taskflow/taskflow-2.4.0.tar.gz
Source0  : http://tarballs.openstack.org/taskflow/taskflow-2.4.0.tar.gz
